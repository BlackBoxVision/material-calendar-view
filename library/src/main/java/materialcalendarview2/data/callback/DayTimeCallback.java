package materialcalendarview2.data.callback;
...
import static materialcalendarview2.util.CalendarUtils.getMonth;
import static materialcalendarview2.util.CalendarUtils.getYear;
import static materialcalendarview2.util.CalendarUtils.getFirstDayOfWeek;
import static materialcalendarview2.util.CalendarUtils.isWeekend;

/**
 * @author jonatan.salas
 */
public final class DayTimeCallback implements CallBack<List<DayTime>> {
    private final Calendar calendar;
    private final int index;

    public DayTimeCallback(final Calendar calendar, final int index) {
